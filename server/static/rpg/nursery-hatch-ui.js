(function () {
	...
	function particles() { const host = el('span', 'rpg-hatch-particles'); for (let i = 0; i < 14; i++) { const p = el('i'); p.style.setProperty('--hatch-angle', (i * 360 / 14) + 'deg'); p.style.setProperty('--hatch-delay', ((i % 4) * 0.06) + 's'); host.append(p); } return host; }
