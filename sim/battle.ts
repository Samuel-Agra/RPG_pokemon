...
import { RPGManager, type RPGBattleState } from './rpg-showdown';
...
export class Battle {
	...
	constructor(options: BattleOptions) {
		...
		this.rpg = options.rpg ? { ...options.rpg } : undefined;
	...
	runAction(action: Action) {
		...
		case 'move':
			...
			break;
		case 'rpgItem':
			RPGManager.runQueuedBattleAction(this, action.pokemon, action.rpgActionId!);
			break;
		case 'megaEvo':
