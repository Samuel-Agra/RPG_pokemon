...
export default configure([
	{
		ignores: [
			...
			"server/static/rpg/vendor/showdown/",
		],
	},
	{
		name: "JavaScript",
	...
	{
		name: "RPG TypeScript",
		files: ["server/rpg-showdown/**/*.{ts,tsx}", "sim/rpg-showdown/**/*.{ts,tsx}"],
		rules: {
			"@stylistic/max-len": "off",
	...
	{
		name: "RPG browser code",
		files: ["server/static/rpg/**/*.js"],
		languageOptions: {
			globals: {
				...globals.browser,
				RPGAssets: "readonly",
				RPG_BATTLE_SCENES: "readonly",
				pokemonSprite: "readonly",
				renderMasterBattles: "readonly",
				renderPlayerBattles: "readonly",
				rpgBattleSceneUrl: "readonly",
				rpgLoadBattlePokemon: "readonly",
				rpgLoadBattleScenes: "readonly",
				rpgPlayerParticipantChoice: "readonly",
				rpgRuntimeItemIcon: "readonly",
				rpgRuntimeSprite: "readonly",
				spriteImage: "readonly",
			},
		},
		rules: {
			"@stylistic/max-len": "off",
	...
	{
		name: "RPG tests",
		files: ["test/server/rpg-*.js", "test/sim/rpg-*.js"],
		rules: {
			"@stylistic/max-len": "off",
			"@stylistic/max-statements-per-line": "off",
			"no-promise-executor-return": "off",
